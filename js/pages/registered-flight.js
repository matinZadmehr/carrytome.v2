...
const FLIGHT_DATA = [
  { id: 1, fromCode: 'THR', toCode: 'DXB', route: 'تهران به دبی', date: '۱۲ مهر', cargo: 'لپ‌تاپ (۲ کیلوگرم)', cargoIcon: 'luggage', reward: '۲۱۰ OMR', image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBq...', verified: true, weight: 2, rewardValue: 210, dateValue: 12 },
  { id: 2, fromCode: 'IST', toCode: 'LHR', route: 'تهران به مسقط', date: '۱۵ مهر', cargo: 'مدارک (۰.۵ کیلوگرم)', cargoIcon: 'description', reward: '۲۲۰ OMR', image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuA...', verified: true, weight: 0.5, rewardValue: 220, dateValue: 15 },
  { id: 3, fromCode: 'DXB', toCode: 'JFK', route: 'مسقط به تهران', date: '۱۸ مهر', cargo: 'ساعت (۰.۳ کیلوگرم)', cargoIcon: 'watch', reward: '۲۴۰ OMR', image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBg...', verified: false, weight: 0.3, rewardValue: 240, dateValue: 18 }
];
